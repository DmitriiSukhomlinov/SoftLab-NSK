...
//
//
//  Copyright(c) 2005-2018 Luxand, Inc.
//         http://www.luxand.com
//
///////////////////////////////////////////////////
...
#define FSDKE_CAMERA_INDEX_DOES_NOT_EXIST       -27
#define FSDKE_PLATFORM_NOT_LICENSED             -28
...
#define FSDKP_FACE_CONTOUR14	66
#define FSDKP_FACE_CONTOUR15	67
#define FSDKP_FACE_CONTOUR16	68
#define FSDKP_FACE_CONTOUR17	69
...
int _FSDKIMPORT_ FSDK_LoadImageFromFileWithAlpha(HImage * Image, const char * FileName);
...
int _FSDKIMPORT_ FSDK_PurgeID(HTracker Tracker, long long ID);
